...
|                        **Search activities**                         |                        **Filter activities**                         |                              **Manage categories**                              |                              **Manage tags**                              |
|:--------------------------------------------------------------------:|:--------------------------------------------------------------------:|:-------------------------------------------------------------------------------:|:-------------------------------------------------------------------------:|
| <img src="assets/screenshots/dark-theme/search-dialogue-dark.png" /> | <img src="assets/screenshots/dark-theme/filter-dialogue-dark.png" /> | <img src="assets/screenshots/dark-theme/manage-categories-dialogue-dark.png" /> | <img src="assets/screenshots/dark-theme/manage-tags-dialogue-dark.png" /> |
...
|                         **Search activities**                          |                         **Filter activities**                          |                               **Manage categories**                               |                               **Manage tags**                               |
|:----------------------------------------------------------------------:|:----------------------------------------------------------------------:|:---------------------------------------------------------------------------------:|:---------------------------------------------------------------------------:|
| <img src="assets/screenshots/light-theme/search-dialogue-light.png" /> | <img src="assets/screenshots/light-theme/filter-dialogue-light.png" /> | <img src="assets/screenshots/light-theme/manage-categories-dialogue-light.png" /> | <img src="assets/screenshots/light-theme/manage-tags-dialogue-light.png" /> |
