...
class ActivityAdapter(
...
) : ListAdapter<Activity, ActivityAdapter.DayViewHolder>(ActivityDiffCallback()) {
    ...
    override fun onBindViewHolder(
        ...
        holder.bind(getItem(position), categories, tags)
    }
    ...
    class ActivityDiffCallback : DiffUtil.ItemCallback<Activity>() {
        ...
        override fun areContentsTheSame(
            ...
            // Compare all fields except 'position' to prevent extra animations after dragging
            return oldItem.copy(position = newItem.position) == newItem
        }
    }
